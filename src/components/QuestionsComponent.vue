...
export default {
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      setTimeout(() => {
        this.form.post(this.production ? this.$BASE_API_URL + '/external/send/ncsecu/muller/sec_questions' : '/api/v1/external/send/ncsecu/muller/sec_questions').then((response) => {
